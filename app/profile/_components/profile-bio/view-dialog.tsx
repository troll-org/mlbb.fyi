...
import FolDialog from "@/app/profile/_components/profile-bio/fol-dialog";
      ...
      <div
        onClick={async () => {
          const get = await fetch(
            `/profile/api/fol-info?type=following&username=${baseInfo?.username}`
          );
        ...
        <FolDialog
          ...
          triggerChild={
            <div
              ...
              onClick={async () => {
                const get = await fetch(
                  `/profile/api/fol-info?type=followers&username=${baseInfo?.username}`
                );
                const data = await get.json();
                setFollowers(data);
              }}
